...
import { CartContext, CartContextType, ProductType } from '../contexts/CartContext';
		...
		{cart.map((product: ProductType) => (
			<li key={product.id}>
				{pic && <picture><img src={product.picture} alt={product.name} /></picture>}
					...
					<li>Sous-total : <span className='red-color'>{product.quantity*product.price}</span> &euro;</li>
